...
window.addEventListener("load", () => {
  Object.values(document.getElementsByClassName("job-time-interval")).forEach((interval_element) => {
    ...
    time_interval_text += " - ";
    if (end_date.getMonth() == new Date().getMonth() && end_date.getFullYear() == new Date().getFullYear()) {
