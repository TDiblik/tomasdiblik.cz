window.addEventListener("load", () => {
  ...
  document.getElementById("project-type-selector").addEventListener("change", (e) => {
    ...
    for (let i = 0; i < all_containers.length; i++) {
      ...
      let visible_projects_count = current_container.querySelectorAll(".project-wrapper").length;
      let hidden_project_count = current_container.querySelectorAll(".project-wrapper.project-hidden").length;
