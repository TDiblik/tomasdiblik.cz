...
window.addEventListener("load", () => {
  // Set footer date
  document.getElementById("footer-end-date").innerText = new Date().getFullYear();

  // Set navbar events
  Object.values(document.getElementsByClassName("menu-icon-wrapper")).forEach((menu_icon_element) => {
